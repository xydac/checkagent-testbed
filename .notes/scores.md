...
| checkagent.core.tracer API (session-054) | 3 | 4 | install_patches/uninstall_patches/TracerContext/begin_probe_trace/end_probe_trace all at top-level; is_installed() missing (F-124). Idempotent install/uninstall. Still no captured events (F-120 open). | 2026-05-17 |
