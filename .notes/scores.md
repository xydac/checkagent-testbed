...
| check_behavioral_compliance (overall) | 5 | 4 | F-115/F-116 FIXED (session-047): findings now inherit probe severity; SafetyFinding.probe populated from probe.name. Still not at top-level checkagent (F-117 open). | 2026-04-30 |
...
| scan history persistence | 5 | 4 | Each scan auto-saved to .checkagent/history/; JSON output includes 'history' delta key (previous_date, previous_score, current_score, score_delta); terminal shows → / ↑ / ↓ arrow; F-118 (score_delta is -0.0 for equal scores) | 2026-04-30 |
