...
| --llm-judge claude-code | 5 | 4 | New: uses local Claude Code CLI (no API key needed); $0.00 cost; more accurate than regex (echo agent correctly passes); clear header "Evaluator: LLM judge (claude-code)"; F-132: no judge_model in JSON output | 2026-05-26 |
