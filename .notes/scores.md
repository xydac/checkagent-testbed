...
| --extra-body flag (scan HTTP) | 5 | 4 | New in session-056: merges extra JSON into every HTTP probe request; enables Dify/custom API endpoint scanning; probe input overrides conflicting extra-body fields; invalid JSON/non-objects give clear errors; F-126: silently ignored on callable targets | 2026-05-19 |
